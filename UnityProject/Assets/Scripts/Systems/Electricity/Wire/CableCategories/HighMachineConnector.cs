...
{
	public class HighMachineConnector : NetworkBehaviour, ICheckedInteractable<PositionalHandApply>
	{
		...
		public PowerTypeCategory ApplianceType = PowerTypeCategory.HighMachineConnector;
